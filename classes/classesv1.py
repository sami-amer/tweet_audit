"""Version 1.0 of the classes required to run the auditor"""
...
class TwitterHandler:
    ...
    Init Arguments:
        bearer_token (str): Twitter API bearer token, required for authentication. Should be set in env
        logger (logging.Logger): Handler-specific logger, defined outside the class and passed at init
    """
    ...
    def bearer_oauth(self, r):
        ...
        """
        # --- Code Taken from Official Twitter API Examples
    ...
    def get_from_endpoint(self, url: str, params=None) -> dict:
        ...
        Arguments:
            url     (str): the url generated by a function, should be a Twitter API URL
    ...
    def post_to_endpoint(self, url: str, payload: dict) -> dict:
        """
        Posts a json payload to the specified url

        Arguments:
            url     (str): the url generated by a function, should be a Twitter API URL
            params  (str): parameters that need to be passed with the url
        """
        # --- Code Taken from Official Twitter API Examples
    ...
    def delete_rules(self, ids: list) -> None:
        ...
        Arguments:
            ids (list): a list of rule ids, usually automatically generated by `get_rules()`
        """
        payload = {"delete": {"ids": ids}}
        url = "https://api.twitter.com/2/tweets/search/stream/rules"
    ...
    def set_rules(self, rules: list[dict]) -> dict or None:
        ...
        Arguments:
            rules (list[dict]): a list of dictionaries, where each one represents a rule
        """
        payload = {"add": rules}
        url = "https://api.twitter.com/2/tweets/search/stream/rules"
...
class TweetDB:
    ...
    def wait_to_wake(self) -> None:
        """
        Waiting function that checks event flags until the thread is unlocked
        """
    ...
    def get_sleep_status(self) -> bool:
        """
        Returns teh sleep status of the object
        """
        return self.sleep_status

    def cache(self, json_response: dict) -> None:
        """
        Adds the json response to the queue for parsing
        """
    ...
    def parse(self, tweet_data: dict) -> None:
        """
        Parses json into each part of the tweet, and puts it into the queue for SQL uploading
        """
    ...
    def connect_to_queue(self) -> None:
        """
        Connectes to the queue until the queue is empty, parsing everything available in FIFO order
        """
    ...
    def offload_db(self):
        """
        When the object sleeps, it offloads all of the current dictionary to a pickle, in case of issues.
        """
...
class SQLPipe:
    ...
    def execute_SQL(self, insert_values):
        """
        Inserts the `insert_values` into the SQL table associated with the object
        """
